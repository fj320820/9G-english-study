...
import { WRITING_TASKS } from "../src/data/writingTasks.ts";
...
Return response in strict JSON format.`;
    ...
    // 5. Output full server logs with fallback notice info
    ...
    try {
      ...
      let errorMessage = "Unknown server-side error during Gemini API request.";
